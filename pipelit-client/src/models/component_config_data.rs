...
pub struct ComponentConfigData {
    ...
    #[serde(rename = "llm_credential_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "llm_model_config_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub llm_model_config_id: Option<Option<i32>>,
    #[serde(rename = "credential_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
