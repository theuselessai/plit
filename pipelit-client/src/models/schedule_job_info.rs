...
impl ScheduleJobInfo {
    pub fn new(id: String, status: String, run_count: i32, error_count: i32, current_repeat: i32, current_retry: i32, total_repeats: i32, max_retries: i32, timeout_seconds: i32, interval_seconds: i32, last_run_at: Option<String>, next_run_at: Option<String>) -> ScheduleJobInfo {
        ScheduleJobInfo {
            id,
            status,
            run_count,
